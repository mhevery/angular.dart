...
void main() {
  var staticFieldGetterFactory = new StaticFieldGetterFactory({
      'methodA': (o) => o.methodA,
      'toUpperCase': (o) => o.toUpperCase,
      'toLowerCase': (o) => o.toLowerCase,
      'count': (o) => o.count,
  });

  they(FieldGetterFactory fieldGetterFactory, String modeName) {
    describe('WatchGroup-$modeName', () {
      var context;
      var watchGrp;
      ...
      beforeEach(inject((Logger _logger) {
        context = {};
        changeDetector = new DirtyCheckingChangeDetector(fieldGetterFactory);
        watchGrp = new RootWatchGroup(fieldGetterFactory, changeDetector, context);
        logger = _logger;
      }));
  ...
  they(new DynamicFieldGetterFactory(), 'dynamic');
  they(staticFieldGetterFactory, 'static');
}
