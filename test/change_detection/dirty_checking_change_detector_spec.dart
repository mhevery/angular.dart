library dirty_checking_change_detector_spec;
...
void main() {
  ...
  they(FieldGetterFactory fieldGetterFactory, String modeName) {
    describe('DirtyCheckingChangeDetector-$modeName', () {
      DirtyCheckingChangeDetector<String> detector;

      beforeEach(() {
        detector = new DirtyCheckingChangeDetector<String>(fieldGetterFactory);
      });
